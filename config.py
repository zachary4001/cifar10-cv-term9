...
IS_LOCAL = os.path.exists(r'Q:\scripts\projects\ComputerVision-Term9')
if IS_LOCAL:
    PROJECT_PATH = r'Q:\scripts\projects\ComputerVision-Term9'
else:
    PROJECT_PATH = os.path.dirname(os.path.abspath(__file__))

# Paths
DATA_PATH     = os.getenv('DATA_PATH',     os.path.join(PROJECT_PATH, 'data'))
OUTPUT_PATH   = os.getenv('OUTPUT_PATH',   os.path.join(PROJECT_PATH, 'outputs'))
